...
I'm not suggesting any of the following hardware, just offering up options. <b><i> Make your own choices. </b></i>
 ...
 - A [case](https://www.thingiverse.com/thing:4816827) to house your controller for ease of mounting. Note that if you use this for an ESP32, you should print X axis at 102% for a better fit. Here's a local link to the same files, credit to Rainer Winkel on Thingiverse: [Case](https://github.com/Gliptopolis/WLED_Klipper/tree/main/4816827_NodeMCU__ESP_8266__Case/files)
